            ...
            rrhh_tool = QueryEngineTool(
                ...
                metadata=ToolMetadata(
                    ...
                    description=(
                        ...
                        "- Solicitudes de crédito/préstamo (Credid, estudios de crédito)\n"
                        ...
                        "✅ '¿Hay credids pendientes de hacer?'\n"
            ...
            reminders_tool = QueryEngineTool(
                ...
                metadata=ToolMetadata(
                    ...
                    description=(
                        ...
                        "NO USAR para información general de créditos credid, vacaciones de otros empleados o temas de RRHH (usa rrhh_info).\n"
...
# -------- Búsqueda general en internet --------
    ...
    def _easycore_tool_description(self, allowed_tables: list[str]) -> str:
        return (
            ...
            "USAR CUANDO el usuario pregunta sobre:\n"
            "- Usuarios del sistema, contactos corporativos\n"
            "- Ventas, transacciones, facturas, pagos\n"
            "- Inventario, productos, stock\n"
            "- Reportes operativos internos\n"
            "- Datos de usuarios internos (nombres, emails, teléfonos)\n"
            ...
            "🚫 NO USAR para 'clientes admin', clientes personales, o qué buscan los clientes (usa customer_info).\n"
            "🚫 NO USAR para propiedades o bienes raíces (usa property_info).\n"
